...
function part01() {
  return validNumbers.reduce((acc, number) => number.number + acc, 0)
}

function part02() {
  return validGears.reduce((acc, gear) => acc + gear.gearRatio, 0)
}

console.log('Part 1: ', part01())
console.log('Part 2: ', part02())

// Read original solution from https://github.com/jens-ox/aoc/blob/main/2023/3.ts
